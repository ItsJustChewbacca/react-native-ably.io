...
import { StyleSheet, View, AsyncStorage, Text, TextInput, Button, ScrollView } from "react-native";
...
subscribe = () => {
  ably = new Realtime({
    key: "UlaOOA.HKjnCg:dPZsgpNbz7LPT2tC",
...
submitChat = () => {
  if (this.state.txt != "") {
    fetch("http://192.168.1.109:3000/send_message", {
      method: "POST",
      headers: {
